...
Route::get(ServiceProvider::DASHBOARD_WIDGETS.'/preview', 'D4T\Admin\Demos\Http\Controllers\Dashboards\WidgetController@preview');
...
Route::get(ServiceProvider::DASHBOARD_PROP_SIMPLIFIED.'/preview', 'D4T\Admin\Demos\Http\Controllers\Dashboards\PropSimplifiedController@preview');
...
Route::get('components-check-and-radio/preview', 'D4T\Admin\Demos\Http\Controllers\Components\CheckboxAndRadioController@preview');
...
Route::get(ServiceProvider::COMPONENTS_MODAL.'/preview', 'D4T\Admin\Demos\Http\Controllers\Components\ModalController@preview');
...
Route::get(ServiceProvider::COMPONENTS_CHARTS.'/preview', 'D4T\Admin\Demos\Http\Controllers\Components\ChartController@preview');
...
Route::get(ServiceProvider::COMPONENTS_LOADING.'/preview', 'D4T\Admin\Demos\Http\Controllers\Components\LoadingController@preview');
...
Route::get(ServiceProvider::GRIDS_REPORT.'/preview', 'D4T\Admin\Demos\Http\Controllers\Grids\ReportController@preview');
...
Route::get(ServiceProvider::GRIDS_FIXED.'/preview', 'D4T\Admin\Demos\Http\Controllers\Grids\FixedColumnsController@preview');
...
Route::get(ServiceProvider::GRIDS_TREE.'/preview', 'D4T\Admin\Demos\Http\Controllers\Grids\GridTreeController@preview');
...
Route::get(ServiceProvider::GRIDS_MOVIE_COMING.'/preview', 'D4T\Admin\Demos\Http\Controllers\Grids\Movies\ComingSoonController@preview');
...
Route::get(ServiceProvider::GRIDS_MOVIE_IN_THEATRE.'/preview', 'D4T\Admin\Demos\Http\Controllers\Grids\Movies\InTheaterController@preview');
...
Route::get(ServiceProvider::GRIDS_MOVIE_TOP.'/preview', 'D4T\Admin\Demos\Http\Controllers\Grids\Movies\Top250Controller@preview');
...
Route::get(ServiceProvider::GRIDS_BORDER_TABLE.'/preview', 'D4T\Admin\Demos\Http\Controllers\Grids\BorderTableController@preview');
...
Route::get(ServiceProvider::EDITORS_TINYMCE.'/preview', 'D4T\Admin\Demos\Http\Controllers\Forms\EditorController@preview');
...
Route::get(ServiceProvider::FORMS_STEP.'/preview', 'D4T\Admin\Demos\Http\Controllers\Forms\StepFormController@preview');
Route::post(ServiceProvider::FORMS_STEP, 'D4T\Admin\Demos\Http\Controllers\Forms\StepFormController@store');
